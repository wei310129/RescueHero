...
import static tw.com.aidenmade.rescuehero.enums.TTLType.HOUR_1;
...
public enum CacheDefinition {
    // JWT
    JWT_ACCESS_TOKEN(CacheName.JWT_ACCESS_TOKEN, DAY_7),
    JWT_REFRESH_TOKEN(CacheName.JWT_REFRESH_TOKEN, HOUR_1),
