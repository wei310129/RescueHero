...
@Mapper(componentModel = "spring", uses = {TimeMapper.class, AuditInfoProjectionMapper.class, RescueGroupProjectionMapper.class, DisasterProjectionMapper.class, StatusProjectionMapper.class, RescueGroupTaskItemProjectionMapper.class})
